 ...
 *
 * Ported from: src/categorizer/protocols.py
 */
...
export const UNISWAP_V3_ROUTER2 = '0x68b3465833fb72a70ecdf485e0e4c7bd8665fc45';
export const UNISWAP_V3_FACTORY = '0x1f98431c8ad98523631ae4a59f267346ea31f984';
export const UNISWAP_V3_NFT_MANAGER = '0xc36442b4a4522e871399cd717abdd847ab11fe88';
...
export const ONE_INCH_V5 = '0x1111111254eeb25477b68fb85ed929f73a960582';
export const ONE_INCH_V6 = '0x111111125421ca6dc452d289314280a0f8842a65';
export const PARASWAP_V5 = '0xdef171fe48cf0115b1d80b88dc8eab59176fee57';
...
export const COMPOUND_V2_COMPTROLLER = '0x3d9819210a31b4961b30ef54be2aed79b9c9cd3b';
export const COMPOUND_V3_USDC = '0xc3d688b66703497daa19211eedff47f25384cdc3';
export const MAKER_DAI_JOIN = '0x9759a6ac90977b93b58547b4a71c78317f391a28';
export const MAKER_VAT = '0x35d1b3f3d7966a1dfe207aa4514c12a259a0492b';
...
export const ROCKETPOOL_DEPOSIT = '0xdd3f50f8a6cafbe9b31a427582963f465e745af8';
export const ROCKETPOOL_RETH = '0xae78736cd615f374d3085123a210448e74fc6393';
export const FRAX_ETH = '0x5e8422345238f34275888049021821e8e08caa1f';
export const CBETH = '0xbe9895146f7af43049ca1c1ae358b0541ea49704';

// -- Bridges --
export const ARBITRUM_BRIDGE = '0x8315177ab297ba92a06054ce80a67ed4dbd7ed3a';
export const ARBITRUM_GATEWAY = '0x72ce9c846789fdb6fc1f34ac4ad25dd9ef7031ef';
export const OPTIMISM_BRIDGE = '0x99c9fc46f92e8a1c0dec1b1747d010903e884be1';
export const OPTIMISM_L2BRIDGE = '0x4200000000000000000000000000000000000010';
export const BASE_BRIDGE = '0x3154cf16ccdb4c6d922629664174b904d80f2c35';
export const POLYGON_BRIDGE = '0xa0c68c638235ee32657e8f720a23cec1bfc77c77';
export const POLYGON_POS_BRIDGE = '0x40ec5b33f54e0e8a33a975908c5ba1c14e5bbbdf';
...
export const STARGATE_ROUTER = '0x8731d54e9d02c286767d56ac03e8037c07e01e98';
export const STARGATE_ROUTER_V2 = '0x45f1a95a4d3f3836523f5c83673c797f4d4d263b';
export const ACROSS_BRIDGE = '0x5c7bcd6e7de5423a257d81b442095a1a6ced35c5';
export const ACROSS_V3 = '0x5ef6c01e11412d2723d600d7a4e40b9e0c441ab0';
export const SYNAPSE_BRIDGE = '0x2796317b0ff8538f3370fef76e4058e5d13c4c37';
export const ORBITER_BRIDGE = '0x80c67432656d59144ceff962e8faf8926599bcf8';
export const ORBITER_V2 = '0xe4edb277e41dc89ab076a1f049f4a3efa700bce8';
export const WORMHOLE_BRIDGE = '0x3ee18b2214aff97000d974cf647e7c347e8fa585';
export const WORMHOLE_TOKEN_BRIDGE = '0x98f3c9e6e3face36baad05fe09d375ef1464288b';
export const CELER_BRIDGE = '0x5427fefa711eff984124bfbb1ab6fbf5e3da1820';
export const MULTICHAIN_ROUTER = '0x6b7a87899490ece95443e979ca9485cbe7e71522';
export const LAYERZERO_ENDPOINT = '0x66a71dcef29a0ffbdbe3c6a460a3b5bc225cd675';

// -- Yield / Vaults --
export const YEARN_VAULT_V2 = '0x19d3364a399d251e894ac732651be8b0e4e85001'; // yvDAI example
export const YEARN_VAULT_V2_USDC = '0xa354f35829ae975e850e23e9615b11da1b3dc4de';
...
export const CONVEX_CVX_TOKEN = '0x4e3fbd56cd56c3e72c1403e103b45db9da5b9d2b';
export const BEEFY_VAULT = '0x453d4ba9a2d594314df88564248497f7d74d6b2c'; // example

// -- NFT Marketplaces --
export const OPENSEA_SEAPORT_V1_5 = '0x00000000000000adc04c56bf30ac9d3c0aaf14dc';
export const OPENSEA_SEAPORT_V1_4 = '0x00000000000001ad428e4906ae43d8f9852d0dd6';
export const OPENSEA_WYVERN_V2 = '0x7be8076f4ea4a4ad08075c2508e481d6c946d12b';
export const BLUR_MARKETPLACE = '0x00000000000111abe46ff893f3b2fdf1f759a8a8';
export const LOOKSRARE = '0x59728544b08ab483533076417fbbb2fd0b17ce3a';
export const X2Y2 = '0x74312363e45dcaba76c59ec49a13aa114034c39b';

// -- Wrapped Tokens (non-taxable wraps) --
export const WETH_ADDRESS = '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2';
export const WBTC_ADDRESS = '0x2260fac5e5542a773aa44fbcfedf7c193bc2c599';
export const STETH_ADDRESS = LIDO_STETH;
...
export const PANCAKESWAP_NFT_MANAGER = '0x46a15b0b27311cedf172ab29e4f4766fbe7f4364';

// -- Trader Joe (Avalanche) --
export const TRADER_JOE_ROUTER = '0x60ae616a2155ee3d9a68541ba4544862310933d4';
export const TRADER_JOE_ROUTER_V2_1 = '0xb4315e873dbcf96ffd0acd8ea43f689d8c20fb30';
export const TRADER_JOE_FACTORY = '0x9ad6c38be94206ca50bb0d90783181834c6a9dae';
...
export const GMX_ROUTER_ARB = '0xabb6f0dc168da9424e8ef25fe0d7e21249e0c9fa';
export const GMX_VAULT_ARB = '0x489ee077994b6658eafa855c308275ead8097c4a';
export const GMX_ROUTER_V2_ARB = '0x7c68c7866a64fa2160f78eeae12217ffbf871fa8';
export const GMX_ROUTER_AVAX = '0x5f719c2f1095f7b9996fd222a9e5e8a29e8e0c5c';
export const GMX_VAULT_AVAX = '0x9ab2de34a33fb459b538c43f251eb825645e8595';

// -- Jupiter (Solana -- program IDs, not EVM addresses) --
export const JUPITER_V6_PROGRAM = 'JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4';
export const JUPITER_LIMIT_ORDER = 'jupoNjAxXgZ4rjzxzPMP4oxduvQsQtZzyknqvzYNrNu';
...
export const RAYDIUM_CPSWAP = 'CPMMoo8L3F4NbTegBCKVNunggL7H1ZpdTHKxQB5qKP1C';
...
export const BRIDGE_ADDRESSES: ReadonlySet<string> = new Set([
...
export const DEX_ADDRESSES: ReadonlySet<string> = new Set([
...
// -- Lending address set --
export const LENDING_ADDRESSES: ReadonlySet<string> = new Set([
  AAVE_V2_POOL, AAVE_V3_POOL,
  COMPOUND_V2_COMPTROLLER, COMPOUND_V3_USDC,
]);

// -- Vault address set --
export const VAULT_ADDRESSES: ReadonlySet<string> = new Set([
...
// -- Staking address set --
export const STAKING_ADDRESSES: ReadonlySet<string> = new Set([
...
export const SOLANA_PROGRAM_ADDRESSES: Record<string, string> = {
...
export const SOLANA_DEX_PROGRAMS: ReadonlySet<string> = new Set([
  JUPITER_V6_PROGRAM, JUPITER_LIMIT_ORDER,
  RAYDIUM_AMM_V4, RAYDIUM_CLMM, RAYDIUM_CPSWAP,
]);

/**
 * Return protocol name for a contract address, or null if unknown.
 *
 * Handles both EVM addresses (lowercased) and Solana program IDs (case-sensitive).
 */
export function resolveProtocol(address: string | null): string | null {
  if (!address) return null;
  // Check Solana programs first (case-sensitive)
  const solanaMatch = SOLANA_PROGRAM_ADDRESSES[address];
  if (solanaMatch) return solanaMatch;
